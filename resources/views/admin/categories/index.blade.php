                        ...
                        <tr>
                            ...
                            <td class="center">
                                @if ($category->published)
                                    <button type="submit"  class="btn btn-success btn-xs" form="form-pub-unpub" formaction="{!! URL::route('categories.unpub', [$category->id]) !!}">Active</button>
                                @else
                                    <button type="submit"  class="btn btn-danger btn-xs  "form="form-pub-unpub" formaction="{!! URL::route('categories.pub', [$category->id]) !!}" >Inactive</button>
                                @endif

                                @if ($category->featured)
                                    <button type="submit"  class="btn btn-primary btn-xs" form="form-feat-unfeat" formaction="{!! URL::route('categories.unfeat', [$category->id]) !!}" >Featured</button>
                                @else
                                    <button type="submit"  class="btn btn-danger btn-xs" form="form-feat-unfeat" formaction="{!! URL::route('categories.feat', [$category->id]) !!}">Not Featured</button>
                                    @endif

                            </td>
                            <td class="center">

                                <a class="btn btn-info" href="{!! URL::route('admin.categories.edit', [$category->id]) !!}">
                                <i class="fa fa-edit"></i>
                                </a>
                                <button type="submit" class="btn btn-danger" form="form-delete" formaction="{!! URL::route('admin.categories.destroy', [$category->id]) !!}">
